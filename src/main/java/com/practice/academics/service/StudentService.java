...
public class StudentService {
    ...
    public ResponseEntity<String> updateStudent(Long studentId, StudentRequestDto studentRequestDto) {
        ...
        if (studentRequestDto.getName() != null && !studentRequestDto.getName().isEmpty() &&
                !Objects.equals(student.getName(), studentRequestDto.getName())) {
            student.setName(studentRequestDto.getName());
        }

        if (studentRequestDto.getEmail() != null && !studentRequestDto.getEmail().isEmpty() &&
                !Objects.equals(student.getEmail(), studentRequestDto.getEmail())) {
            Optional<Student> studentByEmail = studentRepository.findStudentByEmail(studentRequestDto.getEmail());
